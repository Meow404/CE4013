 ...
 */
int facilityManager::addFacilityBooking(std::string clientId, std::string *confirmationId, facility *facility, int s_day, int s_hour, int s_minute, int e_day, int e_hour, int e_minute)
{
    if (!facility)
        return 1;
    ...
    *confirmationId = facility->addBooking(clientId, duration);
 ...
 */
int facilityManager::changeFacilityBooking(std::string clientId, string *confirmationId, facility *facility, int days, int hours, int minutes)
{
    if (!facility)
        return 1;
    ...
    if (!facility->changeBooking(clientId, confirmationId, days, hours, minutes))
        return 2;
    else
        return 0;
}
 ...
 * @retval 0 if booking is siccessfully changes
 */
int facilityManager::extendFacilityBooking(std::string clientId, string *confirmationId, facility *facility, int days, int hours, int minutes)
{
    if (!facility)
        return 1;
    ...
    if (!checkDayTime(days, hours, minutes))
        return 3;
    if (!facility->extendBooking(clientId, confirmationId, days, hours, minutes))
        return 2;
    else
        return 0;
}
